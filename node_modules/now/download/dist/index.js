...
var Buffer = __webpack_require__(184).Buffer;
...
module.exports = global.Promise || __webpack_require__(785);
...
var route = __webpack_require__(626);
...
const loadJsonFile = __webpack_require__(69);
const pathType = __webpack_require__(347);
...
var bomHandling = __webpack_require__(816),
...
iconv.getCodec = function getCodec(encoding) {
    if (!iconv.encodings)
        iconv.encodings = __webpack_require__(943); // Lazy load all encoding definitions.
...
if (nodeVer) {
    ...
    if (nodeVerArr[0] > 0 || nodeVerArr[1] >= 10) {
        __webpack_require__(871)(iconv);
    }

    // Load Node primitive extensions.
    __webpack_require__(813)(iconv);
}
...
const escapeStringRegexp = __webpack_require__(654);
const ansiStyles = __webpack_require__(728);
const stdoutColor = __webpack_require__(334).stdout;

const template = __webpack_require__(325);
...
// Packages
var retrier = __webpack_require__(588);
...
var fs = __webpack_require__(66)
var polyfills = __webpack_require__(434)
var legacy = __webpack_require__(661)
var clone = __webpack_require__(906)
...
var parse_url = __webpack_require__(77).parse;
var Headers = __webpack_require__(288);
var Body = __webpack_require__(410);
...
const hasFlag = __webpack_require__(636);
...
const pify = __webpack_require__(190);
...
var iconvLite = __webpack_require__(248);
// Load Iconv from an external file to be able to disable Iconv for webpack
// Add /\/iconv-loader$/ to webpack.IgnorePlugin to ignore it
var Iconv = __webpack_require__(999);
...
__webpack_require__(64).inherits(FetchError, Error);
...
var bodyStream = __webpack_require__(38);
var PassThrough = __webpack_require__(688).PassThrough;
var FetchError = __webpack_require__(380);
...
var COLON = isWindows ? ';' : ':'
var isexe = __webpack_require__(201)
...
var spdxLicenseIds = __webpack_require__(919)
...
var errorEx = __webpack_require__(742);
var fallback = __webpack_require__(683);
...
var gitHosts = __webpack_require__(584)
var GitHost = module.exports = __webpack_require__(935)
...
var Uni = __webpack_require__(259)
...
const path = __webpack_require__(589);
const fs = __webpack_require__(324);
const stripBom = __webpack_require__(710);
const parseJson = __webpack_require__(516);
const pify = __webpack_require__(190);
...
var scan = __webpack_require__(936)
...
var semver = __webpack_require__(400)
var validateLicense = __webpack_require__(874);
var hostedGitInfo = __webpack_require__(522)
var isBuiltinModule = __webpack_require__(972)
var depTypes = ["dependencies","devDependencies","optionalDependencies"]
var extractDescription = __webpack_require__(233)
var url = __webpack_require__(77)
var typos = __webpack_require__(57)
...
const colorConvert = __webpack_require__(243);
...
var util = __webpack_require__(64);
var isArrayish = __webpack_require__(647);
...
/* MIT license */
var cssKeywords = __webpack_require__(546);
...
var external_fs_ = __webpack_require__(66);
var external_fs_default = /*#__PURE__*/__webpack_require__.n(external_fs_);

// EXTERNAL MODULE: external "path"
var external_path_ = __webpack_require__(589);
var external_path_default = /*#__PURE__*/__webpack_require__.n(external_path_);

// EXTERNAL MODULE: external "child_process"
var external_child_process_ = __webpack_require__(204);

// EXTERNAL MODULE: external "zlib"
var external_zlib_ = __webpack_require__(267);
var external_zlib_default = /*#__PURE__*/__webpack_require__.n(external_zlib_);

// EXTERNAL MODULE: ./node_modules/death/lib/death.js
var death = __webpack_require__(296);
var death_default = /*#__PURE__*/__webpack_require__.n(death);

// EXTERNAL MODULE: ./node_modules/node-fetch/index.js
var node_fetch = __webpack_require__(870);
var node_fetch_default = /*#__PURE__*/__webpack_require__.n(node_fetch);

// EXTERNAL MODULE: ./node_modules/async-retry/dist/index.js
var dist = __webpack_require__(315);
var dist_default = /*#__PURE__*/__webpack_require__.n(dist);

// EXTERNAL MODULE: ./node_modules/which-promise/index.js
var which_promise = __webpack_require__(991);
var which_promise_default = /*#__PURE__*/__webpack_require__.n(which_promise);

// EXTERNAL MODULE: ./node_modules/read-pkg/index.js
var read_pkg = __webpack_require__(244);

// CONCATENATED MODULE: ./download/src/chmod.js
// Native


/* harmony default export */ var chmod = (function(file) {
  const s = external_fs_default.a.statSync(file);
  const newMode = s.mode | 64 | 8 | 1;
  if (s.mode === newMode) return;
  const base8 = newMode.toString(8).slice(-3);
  external_fs_default.a.chmodSync(file, base8);
});

// EXTERNAL MODULE: external "assert"
var external_assert_ = __webpack_require__(393);
var external_assert_default = /*#__PURE__*/__webpack_require__.n(external_assert_);

// EXTERNAL MODULE: ./node_modules/chalk/index.js
var chalk = __webpack_require__(294);
...
// CONCATENATED MODULE: ./download/src/log.js
// Packages
...
function enableProgress(text) {
  external_assert_default()(!bar);

  bar = new progress_default.a(`> ${text} [:bar] :percent`, {
...
function warn(text) {
  console.log(chalk_default.a.red('> Warning!'), text);
}
...
var package_0 = __webpack_require__(818);

// CONCATENATED MODULE: ./download/src/index.js
...
node_fetch_default.a.Promise = Promise;
global.Promise = Promise;
let { platform } = process;
if (detectAlpine()) platform = 'alpine';

const now = external_path_default.a.join(__dirname, 'now');
const targetWin32 = external_path_default.a.join(__dirname, 'now.exe');
...
function detectAlpine() {
  ...
  const ldd = Object(external_child_process_["spawnSync"])('ldd', [process.execPath]).stdout.toString();
  return /\bmusl\b/.test(ldd);
}

async function download() {
  try {
    external_fs_default.a.writeFileSync(
      now,
      '#!/usr/bin/env node\n' +
  ...
  await dist_default()(
    async () => {
      enableProgress('Downloading Now CLI ' + package_0.version);
      showProgress(0);

      try {
        const name = platformToName[platform];
        const url = `https://github.com/zeit/now-cli/releases/download/${package_0.version}/${name}.gz`;
        const resp = await node_fetch_default()(url, { compress: false });
        ...
        const ws = external_fs_default.a.createWriteStream(partial);
        ...
        await new Promise((resolve, reject) => {
          ...
          const gunzip = external_zlib_default.a.createGunzip();
  ...
  external_fs_default.a.renameSync(partial, target);
}
...
async function main() {
  ...
  if (platform === 'win32') {
    try {
      external_fs_default.a.writeFileSync(now, '');
      // Workaround for https://github.com/npm/cmd-shim/pull/25
      const globalPath = external_path_default.a.dirname(await which_promise_default()('npm'));
      let gitBashFile = external_path_default.a.join(globalPath, 'now');
      if (!external_fs_default.a.existsSync(gitBashFile)) {
        gitBashFile = external_path_default.a.join(process.env.APPDATA, 'npm/now');
      }

      external_fs_default.a.writeFileSync(
        gitBashFile,
        modifyGitBashFile(external_fs_default.a.readFileSync(gitBashFile, 'utf8'))
      );
    } catch (err) {
      if (err.code !== 'ENOENT') {
...
module.exports = {"name":"now","version":"13.1.3","preferGlobal":true,"license":"Apache-2.0","description":"The command-line interface for Now","repository":"zeit/now-cli","scripts":{"test":"yarn test-lint","test-unit":"nyc --reporter=html --reporter=text --all ava test/unit.js --fail-fast","test-integration":"ava test/integration.js --serial --fail-fast","test-lint":"eslint .","prepublishOnly":"yarn build-download && cp /dev/null download/dist/now","coverage":"nyc report --reporter=text-lcov > coverage.lcov && codecov","postinstall":"node download/install.js","gzip":"ls packed/now* | xargs gzip","bundle":"pkg bin/now.js -c package.json -o packed/now --options no-warnings","pack":"rm -rf packed && yarn build && yarn bundle","build-download":"ncc build ./download/src --out ./download/dist","link":"yarn run build-dev && cd link && npm link","build":"ncc build -m -s ./src","build-dev":"ncc build ./src","format-modified":"prettier --parser typescript --write --single-quote `git diff --name-only | grep -e \".*\\.ts$\" -e \".*\\.js$\" | xargs echo`"},"nyc":{"include":["src/**"]},"git":{"pre-commit":["test-lint","format-modified"]},"bin":{"now":"download/dist/now"},"files":["download/dist","download/install.js"],"pkg":{"scripts":["dist/*.js"],"targets":["node10-alpine-x64","node10-linux-x64","node10-macos-x64","node10-win-x64"]},"eslintConfig":{"extends":["airbnb","prettier"],"parser":"typescript-eslint-parser","plugins":["typescript"],"settings":{"import/resolver":{"typescript":{}}},"rules":{"camelcase":0,"class-methods-use-this":0,"consistent-return":0,"func-names":0,"global-require":0,"guard-for-in":0,"import/no-duplicates":0,"import/no-dynamic-require":0,"import/no-extraneous-dependencies":0,"import/prefer-default-export":0,"lines-between-class-members":0,"no-await-in-loop":0,"no-bitwise":0,"no-console":0,"no-continue":0,"no-control-regex":0,"no-empty":0,"no-loop-func":0,"no-nested-ternary":0,"no-param-reassign":0,"no-plusplus":0,"no-restricted-globals":0,"no-restricted-syntax":0,"no-shadow":0,"no-underscore-dangle":0,"no-use-before-define":0,"prefer-const":0,"prefer-destructuring":0,"typescript/no-unused-vars":"error"}},"eslintIgnore":["@types","download","dist","test/fixtures","bin","link"],"ava":{"compileEnhancements":false,"extensions":["ts"],"require":["ts-node/register/transpile-only","esm"]},"devDependencies":{"@sentry/node":"4.3.0","@types/ansi-escapes":"3.0.0","@types/async-retry":"1.2.1","@types/debug":"0.0.31","@types/ms":"0.7.30","@types/node-fetch":"2.1.4","@types/ora":"1.3.4","@types/pluralize":"0.0.29","@types/tar-fs":"1.16.1","@types/text-table":"0.2.0","@zeit/dockerignore":"0.0.3","@zeit/git-hooks":"0.1.4","@zeit/ncc":"0.8.1","@zeit/source-map-support":"0.6.2","alpha-sort":"2.0.1","ansi-escapes":"3.0.0","ansi-regex":"3.0.0","arg":"2.0.0","arr-flatten":"1.1.0","async-retry":"1.1.3","async-sema":"2.1.4","ava":"0.25.0","bytes":"3.0.0","chalk":"2.3.1","clipboardy":"1.1.4","codecov":"3.1.0","credit-card":"3.0.1","date-fns":"1.29.0","death":"1.1.0","debug":"3.1.0","deployment-type":"1.0.1","docker-file-parser":"1.0.2","dotenv":"4.0.0","download":"6.2.5","email-prompt":"0.3.2","email-validator":"1.1.1","epipebomb":"1.0.0","eslint":"5.3.0","eslint-config-airbnb":"17.1.0","eslint-config-prettier":"3.3.0","eslint-import-resolver-typescript":"1.1.1","eslint-plugin-import":"2.14.0","eslint-plugin-jsx-a11y":"6.1.1","eslint-plugin-react":"7.11.0","eslint-plugin-typescript":"0.14.0","esm":"3.0.84","execa":"0.9.0","fetch-h2":"1.0.2","glob":"7.1.2","ignore":"3.3.5","ini":"1.3.4","inquirer":"3.3.0","is-url":"1.2.2","jaro-winkler":"0.2.8","jsonlines":"0.1.1","load-json-file":"3.0.0","micro":"9.1.2","mkdirp-promise":"5.0.1","mri":"1.1.0","ms":"2.0.0","node-fetch":"1.7.3","nyc":"13.1.0","ora":"1.3.0","pkg":"4.3.6","pluralize":"7.0.0","prettier":"1.7.2","printf":"0.2.5","progress":"2.0.0","psl":"1.1.29","qr-image":"3.2.0","read-pkg":"2.0.0","semver":"5.5.0","sinon":"4.4.2","strip-ansi":"4.0.0","stripe":"5.1.0","tar-fs":"1.16.3","test-listen":"1.1.0","text-table":"0.2.0","through2":"2.0.3","title":"3.4.0","tmp-promise":"1.0.3","ts-node":"7.0.1","typescript":"3.2.2","typescript-eslint-parser":"21.0.2","update-check":"1.5.3","utility-types":"2.1.0","which-promise":"1.0.0","write-json-file":"2.2.0"}};
...
var parse_url = __webpack_require__(77).parse;
var resolve_url = __webpack_require__(77).resolve;
var http = __webpack_require__(421);
...
var Body = __webpack_require__(410);
var Response = __webpack_require__(690);
var Headers = __webpack_require__(288);
...
var parse = __webpack_require__(704);
var correct = __webpack_require__(480);
...
var RetryOperation = __webpack_require__(616);
...
var fixer = __webpack_require__(722)
normalize.fixer = fixer

var makeWarning = __webpack_require__(631)
...
var gitHosts = __webpack_require__(584)
/* eslint-disable node/no-deprecated-api */
var extend = Object.assign || __webpack_require__(64)._extend
...
var licenses = []
  .concat(__webpack_require__(919))
  .concat(__webpack_require__(120))
var exceptions = __webpack_require__(608)
...
var builtinModules = __webpack_require__(432);
...
module.exports = {
    ...
    'cp936': {
        type: '_dbcs',
        table: function() { return __webpack_require__(955) },
    },

    // GBK (~22000 chars) is an extension of CP936 that added user-mapped chars and some other.
    'gbk': {
        type: '_dbcs',
        table: function() { return __webpack_require__(955).concat(__webpack_require__(366)) },
    },
    'xgbk': 'gbk',
    'isoir58': 'gbk',
...
module.exports = __webpack_require__(190)(__webpack_require__(42), __webpack_require__(210));
...
try {
    ...
    iconv_package = 'iconv';
    Iconv = __webpack_require__(514)(iconv_package).Iconv;
} catch (E) {
